...
import (
	...
	envoycluster_gloo "github.com/solo-io/gloo/projects/gloo/pkg/api/external/envoy/api/v2/cluster" // TODO
	envoycore_gloo "github.com/solo-io/gloo/projects/gloo/pkg/api/external/envoy/api/v2/core" // TODO
)
...
func ToEnvoyHealthCheck(check *envoycore_gloo.HealthCheck) (*envoycore.HealthCheck, error) {
	...
	case *envoycore_gloo.HealthCheck_CustomHealthCheck_:
		...
		case *envoycore_gloo.HealthCheck_CustomHealthCheck_Config:
			converted, err := protoutils.StructGogoToAny(typedConfig.Config)
			if err != nil {
				return nil, err
			}
